...
public class Utils {
    ...
    public void androidSetup() throws MalformedURLException {
        ...
        caps.setCapability("app", System.getProperty("user.dir") + "/build/maersk.apk");
        caps.setCapability("package", "com.maersk.android");
        caps.setCapability("appActivity", "com.maersk.android.ui.MaerskLaunchActivity");
        caps.setCapability(AndroidMobileCapabilityType.APP_WAIT_ACTIVITY,
            "com.maersk.android.ui.accounts.SignInActivity");
    ...
    public void iosSetup() throws MalformedURLException {
        ...
        File app = new File(appDir, "maersk.app");
